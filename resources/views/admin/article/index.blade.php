...
<section class="content">
	<div class="box">
		<div class="box-header">
			<a href="{{route('admin.article.edit')}}" class="btn btn-primary pull-right">新增</a>
		</div>
		<div class="box-body">
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        var table_param = {        
          "sAjaxSource": "{{route('admin.article.list')}}",
          "iDisplayLength": 10,
          'columns':[
            ...
            {'aTargets': [2], 'data': 'created_at'},
            {
              ...
              "render": function(data, type, full) {
                ...
                return "<a href='{{route('admin.article.edit')}}?id="+data+"' class='edit fa fa-pencil-square-o' title='编辑'>编辑</a>"+"&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' class='delete fa fa-close' data-id='" + data + "' title='删除'>删除</a>";
              }
            },
          ]
        };
        ...
        $(document).on('click', '.delete', function(){
            ...
            var id = $(this).data("id");
            $.post('{{route("admin.article.del")}}', {id: id}, function(res){
                    if (res.code == 200) {
